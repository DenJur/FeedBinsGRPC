...
public final class ChatServiceGrpc {
  ...
  public static final String SERVICE_NAME = "feedbins.ChatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<u1467085.feedbins.ChatMessage,
      u1467085.feedbins.ChatMessageFromServer> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = u1467085.feedbins.ChatMessage.class,
      responseType = u1467085.feedbins.ChatMessageFromServer.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<u1467085.feedbins.ChatMessage,
      u1467085.feedbins.ChatMessageFromServer> getChatMethod() {
    io.grpc.MethodDescriptor<u1467085.feedbins.ChatMessage, u1467085.feedbins.ChatMessageFromServer> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod = 
              io.grpc.MethodDescriptor.<u1467085.feedbins.ChatMessage, u1467085.feedbins.ChatMessageFromServer>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "feedbins.ChatService", "chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  u1467085.feedbins.ChatMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  u1467085.feedbins.ChatMessageFromServer.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<u1467085.feedbins.ChatMessage> chat(
        io.grpc.stub.StreamObserver<u1467085.feedbins.ChatMessageFromServer> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                u1467085.feedbins.ChatMessage,
                u1467085.feedbins.ChatMessageFromServer>(
                  this, METHODID_CHAT)))
          .build();
    }
  }
